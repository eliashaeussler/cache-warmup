...
final class SitemapNodeConverterTest extends Framework\TestCase
{
    ...
    public function convertSitemapThrowsExceptionOnMissingLocationNode(): void
    {
    ...
    #[Framework\Attributes\Test]
    public function convertSitemapThrowsExceptionOnInvalidLocationNode(): void
    {
        $this->expectExceptionObject(
            new Src\Exception\SitemapIsMalformed($this->origin, previous: new Src\Exception\UrlIsInvalid('foo')),
        );
    ...
    #[Framework\Attributes\Test]
    public function convertUrlThrowsExceptionOnMissingLocationNode(): void
    {
        $this->expectExceptionObject(
            new Src\Exception\SitemapIsMalformed($this->origin),
        );
    ...
    #[Framework\Attributes\Test]
    public function convertUrlThrowsExceptionOnInvalidLocationNode(): void
    {
        $this->expectExceptionObject(
            new Src\Exception\SitemapIsMalformed($this->origin, previous: new Src\Exception\UrlIsInvalid('foo')),
        );
