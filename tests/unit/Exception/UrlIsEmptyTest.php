 ...
 */
#[Framework\Attributes\CoversClass(Src\Exception\UrlIsEmpty::class)]
final class UrlIsEmptyTest extends Framework\TestCase
{
    #[Framework\Attributes\Test]
    public function constructorCreatesExceptionIfUrlIsEmpty(): void
    {
        $actual = new Src\Exception\UrlIsEmpty();
