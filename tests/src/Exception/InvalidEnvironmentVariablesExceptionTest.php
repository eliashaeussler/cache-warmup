...
/**
 * InvalidEnvironmentVariablesExceptionTest.
 *
 * @author Elias Häußler <elias@haeussler.dev>
 * @license GPL-3.0-or-later
 */
#[Framework\Attributes\CoversClass(Src\Exception\InvalidEnvironmentVariablesException::class)]
final class InvalidEnvironmentVariablesExceptionTest extends Framework\TestCase
{
    ...
    public function createReturnsExceptionForGivenErrors(): void
    {
        ...
        $actual = Src\Exception\InvalidEnvironmentVariablesException::create($error, $nameMapping);
