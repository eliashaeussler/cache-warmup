...
/**
 * SitemapIsInvalidTest.
 *
 * @author Elias Häußler <elias@haeussler.dev>
 * @license GPL-3.0-or-later
 */
#[Framework\Attributes\CoversClass(Src\Exception\SitemapIsInvalid::class)]
final class SitemapIsInvalidTest extends Framework\TestCase
{
    #[Framework\Attributes\Test]
    public function constructorCreatesExceptionForGivenSitemap(): void
    {
        $actual = new Src\Exception\SitemapIsInvalid(null);
