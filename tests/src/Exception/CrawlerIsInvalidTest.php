...
/**
 * CrawlerIsInvalidTest.
 *
 * @author Elias Häußler <elias@haeussler.dev>
 * @license GPL-3.0-or-later
 */
#[Framework\Attributes\CoversClass(Src\Exception\CrawlerIsInvalid::class)]
final class CrawlerIsInvalidTest extends Framework\TestCase
{
    #[Framework\Attributes\Test]
    public function constructorCreatesExceptionForGivenClass(): void
    {
        $actual = new Src\Exception\CrawlerIsInvalid('foo');
