 ...
 */
final class InvalidEnvironmentVariablesException extends Exception
{
    /**
     * @param array<string, string> $nameMapping
     */
    public static function create(Valinor\Mapper\MappingError $error, array $nameMapping = []): self
    {
        $errorMessages = [];
